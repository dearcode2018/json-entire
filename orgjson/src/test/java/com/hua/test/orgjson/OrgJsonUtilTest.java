...
import com.hua.util.OrgJsonUtil;
 ...
 * OrgJsonUtilTest
 */
public final class OrgJsonUtilTest extends BaseTest {
	...
	public void testReadValue() {
		try {
			...
			JSONObject user = OrgJsonUtil.readValue(inputStream);
	...
	public void testReadValues() {
		try {
			...
			JSONArray users =  OrgJsonUtil.readValues(inputStream);
	...
	public void testReadValueByPath() {
		try {
			...
			JSONObject user = OrgJsonUtil.readValueByPath(inputStream, path);
	...
	public void testReadValuesByPath() {
		try {
			...
			JSONArray users = OrgJsonUtil.readValuesByPath(inputStream, path);
	...
	public void testWriteIncludeFile() {
		try {
			...
			OrgJsonUtil.writeValueInclude(file, user, includeFields);
	...
	public void testWriteExcludeFile() {
		try {
			...
			OrgJsonUtil.writeValueExclude(file, user, excludeFields);
