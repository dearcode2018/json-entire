...
/*
 * @JSONType(orders = {"id", "username"}, alphabetic = false)
 * alphabetic 是否按照字段顺序，alphabetic = false 貌似没有生效
 * ignores 忽略列表
 * orders 包含列表 貌似没生效
 */
@JSONType(orders = {"username", "type"}, alphabetic = false, ignores = {"password", "id"})
public final class JSONTypeBean extends BaseBean {
