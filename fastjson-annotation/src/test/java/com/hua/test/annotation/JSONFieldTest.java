...
import com.hua.bean.JSONFieldBean;
 ...
 * JSONFieldTest
 */
public final class JSONFieldTest extends BaseTest {

	/**
	 * @JSONField 单独使用 可以指定输出字段的名称
	 */
	...
	public void testJSONField() {
		try {
			JSONFieldBean user = new JSONFieldBean();
			user.setId("20150628");
			user.setUsername("张三");
