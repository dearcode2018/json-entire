 ...
 * JsonParserTest
 */
public final class JsonParserTest extends BaseTest {
	...
	public void testJsonParser() {
		try {
			...
			//content = "123";
			jsonParser = factory.createParser(content);
			User user = jsonParser.readValueAs(User.class);
			System.out.println(user.toString());
			//log.info("testJsonParser =====> " + jsonParser.getText());
			//log.info("testJsonParser =====> " + jsonParser.getByteValue());
			
		} catch (Exception e) {
			log.error("testJsonParser =====> ", e);
		}
	}	
