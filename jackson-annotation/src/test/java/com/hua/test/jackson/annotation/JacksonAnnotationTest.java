 ...
 */
public final class JacksonAnnotationTest extends BaseTest {
	...
	public void testJacksonAnnotation() {
		try {
			...
			log.error("testJacksonAnnotation =====> ", e);
		}
	}
	...
	public void testJsonIgnoreProperties() {
		try {
			...
			log.error("testJsonIgnoreProperties =====> ", e);
		}
	}
	...
	public void testJsonAutoDetect() {
		try {
			...
			log.error("testJsonAutoDetect =====> ", e);
		}
	}
	...
	public void testJsonPropertyOrder() {
		try {
			...
			log.error("testJsonPropertyOrder =====> ", e);
		}
	}
	...
	public void testJsonDeserialize () {
		try {
			...
			log.error("testJsonDeserialize  =====> ", e);
		}
	}
