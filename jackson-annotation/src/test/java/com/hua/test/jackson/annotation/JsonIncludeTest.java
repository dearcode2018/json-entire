...
import com.hua.entity.JacksonInclude;
 ...
 * JsonIncludeTest
 */
public final class JsonIncludeTest extends BaseTest {
	...
	public void testJsonInclude() {
		try {
			JacksonInclude user = new JacksonInclude();
			user.setId("20150628");
			user.setUsername("张三");
