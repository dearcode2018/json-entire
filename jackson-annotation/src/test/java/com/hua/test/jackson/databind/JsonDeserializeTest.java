 ...
 * JsonDeserializeTest
 */
public final class JsonDeserializeTest extends BaseTest {
	...
	public void testJsonDeserialize() {
		try {
			/**
			 * 反序列化，需要给 setter方法标上注解: 
			 * @JsonDeserialize(using = DateDeserializer.class)
			 * @JsonDeserialize(using = DateTimeDeserializer.class)
			 */
			String json = "{\"name\":\"南方人\",\"sex\":false,\"credit\":2.25,\"birthday\":\"2015-03-17\",\"address\":\"广州市天河区\","
					+ "\"items\":[{\"name\":\"订单1\",\"credit\":0.5,\"description\":\"本次订单有效\",\"datetime\":\"2015-03-17 14:35:32\"}]}";
			JacksonCustomBean custom = objectMapper.readValue(json, JacksonCustomBean.class);
			
			System.out.println(custom.getBirthday());
			System.out.println(custom.getItems().iterator().next().getDatetime());
