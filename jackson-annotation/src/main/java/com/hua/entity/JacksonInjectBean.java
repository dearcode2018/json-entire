...
public final class JacksonInjectBean extends BaseBean {
	...
	/* 登录-密码 */
	/**
	 * @JacksonInject 作用在字段上或setter方法上，用于反序列化
	 */
	//@JacksonInject(value = "password")
