...
/*
 * @JsonTypeInfo
 * 当输出操作的对象拥有多个子类型且在反序列化时需要添加子类对象的类型信息，
 * 使用此注解可以正确地设置子类对象的类型
 * 通过这个，可以正确识别到底是反 序列化为某个具体的子类.
 */
@JsonTypeInfo(use = Id.CLASS, include = As.PROPERTY, property = "class")
public final class JacksonTypeInfoBean extends BaseBean {
