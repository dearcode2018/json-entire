...
public final class JacksonUnwrapped extends BaseBean {
	...
	/**
	 * @JsonUnwrapped
	 * 可以去除对象类型的包装，也可以对象里面的字段添加前缀/后缀
	 */
	@JsonUnwrapped(enabled = true, prefix = "p_", suffix = "_s")
	private Name name;
