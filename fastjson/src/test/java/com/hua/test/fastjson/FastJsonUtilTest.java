...
import com.hua.util.FastJsonUtil;
 ...
 * FastJsonUtilTest
 */
public final class FastJsonUtilTest extends BaseTest {
	...
	public void testReadValue() {
		try {
			...
			User user = FastJsonUtil.readValue(inputStream, User.class);
	...
	public void testReadValues() {
		try {
			...
			List<User> users =  FastJsonUtil.readValues(inputStream, User.class);
	...
	public void testReadValueByPath() {
		try {
			...
			User user = FastJsonUtil.readValueByPath(inputStream, path, User.class);
	...
	public void testReadValuesByPath() {
		try {
			...
			List<User> users = FastJsonUtil.readValuesByPath(inputStream, path, User.class);
	...
	public void testWriteIncludeFile() {
		try {
			...
			FastJsonUtil.writeValueInclude(file, user, includeFields);
	...
	public void testWriteExcludeFile() {
		try {
			...
			FastJsonUtil.writeValueExclude(file, user, excludeFields);
